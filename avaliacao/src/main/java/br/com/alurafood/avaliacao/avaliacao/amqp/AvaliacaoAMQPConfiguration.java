...
public class AvaliacaoAMQPConfiguration {
    ...
    @Bean
    public Queue queueDetalhesAvaliacao() {
        return QueueBuilder
...
//DEAD LETTERS QUEUE
    ...
    @Bean
    public Queue queueDeadLettersQueueDetalhesAvaliacao() {
        return QueueBuilder
    ...
    @Bean
    public Binding bindingDLXQueuePaymentOrder() {
        return BindingBuilder
                .bind(queueDeadLettersQueueDetalhesAvaliacao())
